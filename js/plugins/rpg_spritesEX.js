...
@default 0.5
@desc
Specifies the horizontal anchor point (0.0 to 1.0). Default is 0.5 (center).
...
@default 1
@desc
Specifies the vertical anchor point (0.0 to 1.0). Default is 1 (bottom).
*/
/*:ja
@target MV MZ
...
@default 0.5
@desc
水平アンカーポイントを指定します（0.0～1.0）。デフォルトは0.5（中央）。
...
@default 1
@desc
垂直アンカーポイントを指定します（0.0～1.0）。デフォルトは1（下）。
*/
const CharacterMoveMotionExPluginName = document.currentScript
  ? decodeURIComponent(document.currentScript.src.match(/^.*\/(.+)\.js$/)[1])
  : "CharacterMoveMotionEx";
...
(function (CharacterMoveMotionEx) {
  ...
  const PP = PluginParamsParser.parse(
    PluginManager.parameters(CharacterMoveMotionExPluginName),
  );
  const MotionType = {
    WALK: 0,
    WAIT: 1,
  ...
  if (typeof DotMoveSystemPluginName !== "undefined") {
    ...
    CharacterMover.prototype.dotMoveByDeg = function (
      deg,
      dpf = this._character.distancePerFrame(),
      opt = { changeDir: true },
    ) {
      // TODO: 暫定
    ...
    const _CharacterMover_continuousMoveProcess =
      CharacterMover.prototype.continuousMoveProcess;
    ...
    const _Game_CharacterBase_moveStraight =
  ...
  class MoveMotionController {
    ...
    updateResetMotionImage() {
      if (this._saveData.needReset) {
        ...
        this._character.setImage(
          this._character.characterName(),
          this._character.characterIndex(),
        );
      }
    }
    updateEndDashMotion() {
    ...
    updateChangeMotionImage() {
      if (this._saveData.lastMotion !== this._saveData.motion) {
        ...
        if (motionData) {
          if (
            !(this.isDiagonalMotion() && this._character.isDirectionFixed())
          ) {
            this._character.changeMotionImage(
              motionData.CharacterFileName,
              motionData.CharacterIndex,
              motionData.AnchorX || 0.5,
              motionData.AnchorY || 1,
            );
          }
        }
    ...
    getMotionType() {
      ...
      switch (this._saveData.motion) {
        ...
        case MotionType.WAIT:
          if (
            characterMoveMotion.WaitMotion &&
            characterMoveMotion.WaitMotion.CharacterFileName != null
          ) {
        ...
        case MotionType.DASH:
          if (
            characterMoveMotion.DashMotion &&
            characterMoveMotion.DashMotion.CharacterFileName != null
          ) {
        ...
        case MotionType.DIAGONAL_WALK:
          if (
            characterMoveMotion.DiagonalWalkMotion &&
            characterMoveMotion.DiagonalWalkMotion.CharacterFileName != null
          ) {
        ...
        case MotionType.DIAGONAL_DASH:
          if (
            characterMoveMotion.DiagonalDashMotion &&
            characterMoveMotion.DiagonalDashMotion.CharacterFileName != null
          ) {
    ...
    findMoveMotion() {
      for (const characterMoveMotion of PP.CharacterMoveMotionList) {
        ...
        if (
          walkMotion.CharacterFileName ===
          this._character.straightWalkCharacterName()
        ) {
          if (
            ...
            walkMotion.CharacterIndex ===
            this._character.straightWalkCharacterIndex()
          ) {
            return characterMoveMotion;
          }
        }
    ...
    isDiagonalMotion() {
      ...
      return (
        motionType === MotionType.DIAGONAL_WALK ||
        motionType === MotionType.DIAGONAL_DASH
      );
    }
  ...
  class MoveMotionSaveData {
    ...
    get straightWalkCharacterName() {
      return this._straightWalkCharacterName;
    }
    set straightWalkCharacterName(value) {
      this._straightWalkCharacterName = value;
    }
    get straightWalkCharacterIndex() {
      return this._straightWalkCharacterIndex;
    }
    set straightWalkCharacterIndex(value) {
      this._straightWalkCharacterIndex = value;
    }
    get motion() {
      return this._motion;
    }
    ...
    set lastMotion(value) {
      this._lastMotion = value;
    }
    get numPattern() {
      return this._numPattern;
    }
    set numPattern(value) {
      this._numPattern = value;
    }
    get waitReserve() {
      return this._waitReserve;
    }
    set waitReserve(value) {
      this._waitReserve = value;
    }
    get waitMotionDelay() {
      return this._waitMotionDelay;
    }
    set waitMotionDelay(value) {
      this._waitMotionDelay = value;
    }
    get needReset() {
      return this._needReset;
    }
    set needReset(value) {
      this._needReset = value;
    }
    get diagonalMoveDirection() {
      return this._diagonalMoveDirection;
    }
    set diagonalMoveDirection(value) {
      this._diagonalMoveDirection = value;
    }
    get anchorX() {
  ...
  CharacterMoveMotionEx.MoveMotionSaveData = MoveMotionSaveData;
  ...
  Game_CharacterBase.prototype.setImage = function (
    ...
    this._moveMotionSaveData.anchorX = 0.5;
    this._moveMotionSaveData.anchorY = 1;
  ...
  Game_CharacterBase.prototype.changeMotionImage = function (
    characterName,
    characterIndex,
    anchorX = 0.5,
    anchorY = 1,
    ...
    this._moveMotionSaveData.anchorX = anchorX;
    this._moveMotionSaveData.anchorY = anchorY;
    this.resetPattern();
    const numPattern = MoveMotionUtils.getNumPattern(characterName);
    this.moveMotionController().setNumPattern(numPattern);
  };
  ...
  Game_CharacterBase.prototype.straighten = function () {
    if (
      this.hasWalkAnime() ||
      this.hasStepAnime() ||
      this.moveMotionController().isNeedWaitAnimation()
    ) {
  ...
  Game_CharacterBase.prototype.animationWait = function () {
    return Math.round(
      (9 - this.realMoveSpeed()) * this.moveMotionController().motionSpeed(),
    );
  };
  ...
  Game_CharacterBase.prototype.anchorX = function () {
    return this._moveMotionSaveData.anchorX;
  };
  Game_CharacterBase.prototype.anchorY = function () {
    return this._moveMotionSaveData.anchorY;
  };
  ...
  Sprite_Character.prototype.characterPatternY = function () {
    if (this._character.isDiagonalMotion()) {
      switch (this._character.diagonalMoveDirection()) {
        ...
        default:
          throw new Error(
            `invalid direction(${this._character.diagonalMoveDirection()})`,
          );
      }
    } else {
